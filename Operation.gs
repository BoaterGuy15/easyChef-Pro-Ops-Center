...
function doGet(e) {
  try {
    ...
    if(e.parameter.action === 'generate_image_prompt') return respond(generateImagePrompt({ image_brief: decodeURIComponent(e.parameter.image_brief||''), post_hook: decodeURIComponent(e.parameter.post_hook||''), platform: e.parameter.platform||'Facebook', icp: e.parameter.icp||'super_mom', dimensions: e.parameter.dimensions||'1200x630px', use_case: e.parameter.use_case||'social' }));
